...
import com.project.pan.myproject.view.ratingBar.BaseRatingBar;
import com.project.pan.myproject.view.toothbrushChart.ToothBrushRecordsChart;
...
//        }
       ...
       // String tipText = "3 hours/day on average";
        ...
        ToothBrushRecordsChart brushRecordsChart = findViewById(R.id.toothbrush_chart);
        brushRecordsChart.initChart();


       baseRatingBar = (BaseRatingBar) findViewById(R.id.baseratingbar_main);
